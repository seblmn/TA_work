...
class MaintenanceDropoffEvent(VehicleEvent):
    """Scooter maintenance drop-off (instantaneous, no passenger)."""

    def __init__(self, time: int, vehicle, location):
        super(MaintenanceDropoffEvent, self).__init__(time, vehicle)
        self.location = location
